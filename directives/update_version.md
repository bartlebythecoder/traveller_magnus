...
3. **Log the Change**: Add a line to the project's changelog in the README.md and changelog.md with the new version number. If a description is provided, add it to the changelog.  If not, ask the user for a description.
