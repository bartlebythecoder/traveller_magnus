...
## Goal
Update the project versioning across all relevant files consistently.
...
3. **Log the Change**: Add a line to the project's changelog in the README.md and changelog.md.
