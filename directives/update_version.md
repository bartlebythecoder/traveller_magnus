...
3. **Log the Change**: Add a line to the project's changelog in the README.md and changelog.md with the new version number but do not add any other information.
